...
Thanks for your interest. self.ai is GPL-3.0 software (see `LICENSE`;
provenance in `DIVERGENCE.md`). Contributions of all kinds are welcome — code,
docs, bug reports, and reviews.
...
## Do not reintroduce post-v0.5.4 Open-WebUI code

self.ai is a hard fork of Open-WebUI v0.5.4 (the last MIT release) and never
ingests post-v0.5.4 Open-WebUI code. See `DIVERGENCE.md` before referencing any
upstream material.
