...
class PersistentConfig(Generic[T]):
    def __init__(self, env_name: str, config_path: str, env_value: T):
        ...
        self.config_value = (
            get_config_value(config_path) if ENABLE_PERSISTENT_CONFIG else None
        )
...
if LANGUAGE_EVAL_BASE_URLS == "":
    LANGUAGE_EVAL_BASE_URLS = os.environ.get(
        "LANGUAGE_EVAL_BASE_URL", "http://self-language-eval:8096"
    )
...
if CODE_EVAL_BASE_URLS == "":
    CODE_EVAL_BASE_URLS = os.environ.get(
        "CODE_EVAL_BASE_URL", "http://self-code-eval:8094"
    )
CODE_EVAL_BASE_URLS = [url.strip() for url in CODE_EVAL_BASE_URLS.split(";")]
CODE_EVAL_BASE_URLS = PersistentConfig(
    "CODE_EVAL_BASE_URLS", "code_eval.base_urls", CODE_EVAL_BASE_URLS
)
