...
class ERROR_MESSAGES(str, Enum):
    ...
    def DEFAULT(err=""):
        return "Something went wrong :/" if err == "" else "[ERROR: " + str(err) + "]"

    ENV_VAR_NOT_FOUND = "Required environment variable not found. Terminating now."
    CREATE_USER_ERROR = (
        "Oops! Something went wrong while creating your account. Please try "
        "again later. If the issue persists, contact support for assistance."
    )
    DELETE_USER_ERROR = (
        "Oops! Something went wrong. We encountered an issue while trying "
        "to delete the user. Please give it another shot."
    )
    EMAIL_MISMATCH = (
        "Uh-oh! This email does not match the email your provider is "
        "registered with. Please check your email and try again."
    )
    EMAIL_TAKEN = (
        "Uh-oh! This email is already registered. Sign in with your "
        "existing account or choose another email to start anew."
    )
    ...
    INVALID_EMAIL_FORMAT = (
        "The email format you entered is invalid. Please double-check and make "
        "sure you're using a valid email address (e.g., yourname@example.com)."
    )
    ...
    EXISTING_USERS = (
        ...
        "If you want to disable WEBUI_AUTH, make sure your web interface doesn't "
        "have any existing users and is a fresh installation."
    )
    ...
    FILE_NOT_SUPPORTED = (
        "Oops! It seems like the file format you're trying to upload is not "
        "supported. Please upload a file with a supported format "
        "(e.g., JPG, PNG, PDF, TXT) and try again."
    )

    NOT_FOUND = "We could not find what you're looking for :/"
    USER_NOT_FOUND = "We could not find what you're looking for :/"
    API_KEY_NOT_FOUND = (
        "Oops! It looks like there's a hiccup. The API key is missing. Please "
        "make sure to provide a valid API key to access this feature."
    )
    ...
    CREATE_API_KEY_ERROR = (
        "Oops! Something went wrong while creating your API key. Please try "
        "again later. If the issue persists, contact support for assistance."
    )
    ...
    def WEB_SEARCH_ERROR(err=""):
        return err if err else "Oops! Something went wrong while searching the web."

    OLLAMA_API_DISABLED = "The Ollama API is disabled. Please enable it to use this feature."

    def FILE_TOO_LARGE(size=""):
        return (
            f"Oops! The file you're trying to upload is too large. " f"Please upload a file that is less than {size}."
        )
...
class TASKS(str, Enum):
    ...
    def DEFAULT(task=""):
        return task if task else "generation"
